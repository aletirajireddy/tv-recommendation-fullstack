...
import styles from './FiveBucketWidget.module.css';

/**
 * 5 Bucket System
 * Visualizes the market structure based on EMA Position Codes.
 * Buckets:
 * 1. BEARISH (1xx)
 * 2. CHOPPY (2xx)
 * 3. BULLISH (3xx)
...
export function FiveBucketWidget() {
    ...
    const buckets = useMemo(() => {
        ...
        activeScan.results.forEach(item => {
            ...
            else if (code >= 300 && code < 400) groups.bullish.push(item);
